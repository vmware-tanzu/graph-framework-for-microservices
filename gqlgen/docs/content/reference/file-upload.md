...
See the [\_examples/fileupload](https://github.com/vmware-tanzu/graph-framework-for-microservices/gqlgen/tree/master/_examples/fileupload) package for more examples.
