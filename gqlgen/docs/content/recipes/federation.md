...
server in gqlgen. You can find the finished result in the [examples directory](https://github.com/vmware-tanzu/graph-framework-for-microservices/gqlgen/tree/master/_examples/federation).
...
```bash
go run github.com/vmware-tanzu/graph-framework-for-microservices/gqlgen
```
