...
import (
	_ "github.com/vmware-tanzu/graph-framework-for-microservices/gqlgen"
)
```
...
```shell
go get -d github.com/vmware-tanzu/graph-framework-for-microservices/gqlgen@VERSION
```
...
And run `go run github.com/vmware-tanzu/graph-framework-for-microservices/gqlgen generate`.

> If you run into this error `package github.com/vmware-tanzu/graph-framework-for-microservices/gqlgen: no Go files` while executing the `generate` command above, follow the instructions in [this](https://github.com/vmware-tanzu/graph-framework-for-microservices/gqlgen/issues/800#issuecomment-888908950) comment for a possible solution.
...
```go
//go:generate go run github.com/vmware-tanzu/graph-framework-for-microservices/gqlgen generate
```
