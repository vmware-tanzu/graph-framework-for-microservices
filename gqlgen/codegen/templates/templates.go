...
import (
	...
	"github.com/vmware-tanzu/graph-framework-for-microservices/gqlgen/internal/imports"
)
...
func Render(cfg Options) error {
	...
	if cfg.GeneratedHeader {
		result.WriteString("// Code generated by github.com/vmware-tanzu/graph-framework-for-microservices/gqlgen, DO NOT EDIT.\n\n")
	}
	if cfg.PackageDoc != "" {
