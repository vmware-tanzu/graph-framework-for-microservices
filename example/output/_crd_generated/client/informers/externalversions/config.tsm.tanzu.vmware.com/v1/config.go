...
import (
	...
	configtsmtanzuvmwarecomv1 "gitlab.eng.vmware.com/nexus/compiler/_generated/apis/config.tsm.tanzu.vmware.com/v1"
	...
	v1 "gitlab.eng.vmware.com/nexus/compiler/_generated/client/listers/config.tsm.tanzu.vmware.com/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.ConfigTsmV1().Configs(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ConfigTsmV1().Configs(namespace).Watch(context.TODO(), options)
			},
		},
