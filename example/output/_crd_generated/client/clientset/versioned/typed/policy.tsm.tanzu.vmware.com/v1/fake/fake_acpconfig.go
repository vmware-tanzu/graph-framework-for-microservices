...
var acpconfigsKind = schema.GroupVersionKind{Group: "policy.tsm.tanzu.vmware.com", Version: "v1", Kind: "ACPConfig"}
...
func (c *FakeACPConfigs) Get(ctx context.Context, name string, options v1.GetOptions) (result *policytsmtanzuvmwarecomv1.ACPConfig, err error) {
	...
	return obj.(*policytsmtanzuvmwarecomv1.ACPConfig), err
}
...
func (c *FakeACPConfigs) List(ctx context.Context, opts v1.ListOptions) (result *policytsmtanzuvmwarecomv1.ACPConfigList, err error) {
	...
	list := &policytsmtanzuvmwarecomv1.ACPConfigList{ListMeta: obj.(*policytsmtanzuvmwarecomv1.ACPConfigList).ListMeta}
	for _, item := range obj.(*policytsmtanzuvmwarecomv1.ACPConfigList).Items {
