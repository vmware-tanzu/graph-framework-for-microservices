...
import (
	...
	v1 "gitlab.eng.vmware.com/nsx-allspark_users/nexus-sdk/compiler.git/_generated/apis/policy.tsm.tanzu.vmware.com/v1"
	scheme "gitlab.eng.vmware.com/nsx-allspark_users/nexus-sdk/compiler.git/_generated/client/clientset/versioned/scheme"
...
type AccessControlPolicyInterface interface {
	Create(ctx context.Context, accessControlPolicy *v1.AccessControlPolicy, opts metav1.CreateOptions) (*v1.AccessControlPolicy, error)
	Update(ctx context.Context, accessControlPolicy *v1.AccessControlPolicy, opts metav1.UpdateOptions) (*v1.AccessControlPolicy, error)
	Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error
	Get(ctx context.Context, name string, opts metav1.GetOptions) (*v1.AccessControlPolicy, error)
	List(ctx context.Context, opts metav1.ListOptions) (*v1.AccessControlPolicyList, error)
	Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.AccessControlPolicy, err error)
...
func (c *accessControlPolicies) List(ctx context.Context, opts metav1.ListOptions) (result *v1.AccessControlPolicyList, err error) {
...
func (c *accessControlPolicies) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *accessControlPolicies) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
