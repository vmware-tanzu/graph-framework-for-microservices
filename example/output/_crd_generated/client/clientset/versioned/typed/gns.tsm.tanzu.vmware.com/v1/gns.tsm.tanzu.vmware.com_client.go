...
import (
	v1 "gitlab.eng.vmware.com/nsx-allspark_users/nexus-sdk/compiler.git/_generated/apis/gns.tsm.tanzu.vmware.com/v1"
...
func NewForConfig(c *rest.Config) (*GnsTsmV1Client, error) {
	...
	return &GnsTsmV1Client{client}, nil
}

// NewForConfigOrDie creates a new GnsTsmV1Client for the given config and
...
func New(c rest.Interface) *GnsTsmV1Client {
	return &GnsTsmV1Client{c}
}
