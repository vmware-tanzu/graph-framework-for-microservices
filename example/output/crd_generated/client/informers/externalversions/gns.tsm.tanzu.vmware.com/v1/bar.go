	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.GnsTsmV1().Bars().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GnsTsmV1().Bars().Watch(context.TODO(), options)
			},
		},
		&gnstsmtanzuvmwarecomv1.Bar{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *barInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&gnstsmtanzuvmwarecomv1.Bar{}, f.defaultInformer)
}
