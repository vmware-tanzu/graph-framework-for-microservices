...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GnsStatus) DeepCopyInto(out *GnsStatus) {
	*out = *in
	out.Nexus = in.Nexus
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GnsStatus.
func (in *GnsStatus) DeepCopy() *GnsStatus {
	if in == nil {
		return nil
	}
	out := new(GnsStatus)
