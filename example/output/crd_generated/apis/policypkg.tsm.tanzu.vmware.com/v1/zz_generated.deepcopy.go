...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ACPConfigStatus) DeepCopyInto(out *ACPConfigStatus) {
	*out = *in
	out.Nexus = in.Nexus
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ACPConfigStatus.
func (in *ACPConfigStatus) DeepCopy() *ACPConfigStatus {
	if in == nil {
		return nil
	}
	out := new(ACPConfigStatus)
	in.DeepCopyInto(out)
	return out
}
