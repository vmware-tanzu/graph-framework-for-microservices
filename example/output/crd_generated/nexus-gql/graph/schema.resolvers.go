...
// XYZPort is the resolver for the XYZPort field.
func (r *config_ConfigResolver) XYZPort(ctx context.Context, obj *model.ConfigConfig) ([]*int, error) {
	return c.getConfigConfigXYZPortResolver()
}

// ABCHost is the resolver for the ABCHost field.
func (r *config_ConfigResolver) ABCHost(ctx context.Context, obj *model.ConfigConfig) ([]*string, error) {
	return c.getConfigConfigABCHostResolver()
}
...
// Array1 is the resolver for the Array1 field.
func (r *gns_GnsResolver) Array1(ctx context.Context, obj *model.GnsGns) ([]*int, error) {
	return c.getGnsGnsArray1Resolver()
}

// Array2 is the resolver for the Array2 field.
func (r *gns_GnsResolver) Array2(ctx context.Context, obj *model.GnsGns) ([]*model.GnsDescription, error) {
	return c.getGnsGnsArray2Resolver()
}

// Array3 is the resolver for the Array3 field.
func (r *gns_GnsResolver) Array3(ctx context.Context, obj *model.GnsGns) ([]*model.GnsBar, error) {
	return c.getGnsGnsArray3Resolver()
}

// Array4 is the resolver for the Array4 field.
func (r *gns_GnsResolver) Array4(ctx context.Context, obj *model.GnsGns) ([]*float64, error) {
	return c.getGnsGnsArray4Resolver()
}
