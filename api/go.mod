module github.com/vmware-tanzu/graph-framework-for-microservices/api
...
require (
	...
	github.com/vmware-tanzu/graph-framework-for-microservices/gqlgen v0.0.0-20230908154608-60c8916a498f
