...
import (
	...
	confighelloworldcomv1 "gitlab.eng.vmware.com/nsx-allspark_users/nexus-sdk/validation.git/pkg/nexus/generated/apis/config.helloworld.com/v1"
	...
	v1 "gitlab.eng.vmware.com/nsx-allspark_users/nexus-sdk/validation.git/pkg/nexus/generated/client/listers/config.helloworld.com/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.ConfigHelloworldV1().Configs(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ConfigHelloworldV1().Configs(namespace).Watch(context.TODO(), options)
			},
		},
		&confighelloworldcomv1.Config{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *configInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&confighelloworldcomv1.Config{}, f.defaultInformer)
}
