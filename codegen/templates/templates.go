...
import (
	...
	"gitlab.eng.vmware.com/nsx-allspark_users/nexus-sdk/gqlgen.git/internal/imports"
)
...
func Render(cfg Options) error {
	...
	if cfg.GeneratedHeader {
		result.WriteString("// Code generated by gitlab.eng.vmware.com/nsx-allspark_users/nexus-sdk/gqlgen.git, DO NOT EDIT.\n\n")
	}
	if cfg.PackageDoc != "" {
