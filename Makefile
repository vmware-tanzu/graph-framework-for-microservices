...
generate_code:
	...
	cd _generated/nexus-gql && go get github.com/cespare/xxhash/v2@v2.1.2 && go get golang-appnet.eng.vmware.com/nexus-sdk/nexus@test-get-metrics-in-proto && gqlgen generate
