...
import (
	...
	v1 "vmware/build/client/listers/orgchart.vmware.org/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.OrgchartVmwareV1().Roots().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.OrgchartVmwareV1().Roots().Watch(context.TODO(), options)
			},
		},
		&orgchartvmwareorgv1.Root{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *rootInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&orgchartvmwareorgv1.Root{}, f.defaultInformer)
}
