	...
	return &openapi.Config{
		...
		GetDefinitions: func(_ openapi.ReferenceCallback) map[string]openapi.OpenAPIDefinition {
			return map[string]openapi.OpenAPIDefinition{
				"github.com/vmware-tanzu/graph-framework-for-microservices/src/kube-openapi/pkg/builder3.TestInput":  *TestInput{}.OpenAPIDefinition(),
				"github.com/vmware-tanzu/graph-framework-for-microservices/src/kube-openapi/pkg/builder3.TestOutput": *TestOutput{}.OpenAPIDefinition(),
			}
		},
