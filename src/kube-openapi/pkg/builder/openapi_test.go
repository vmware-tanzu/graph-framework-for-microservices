...
import (
	...
	openapi "github.com/vmware-tanzu/graph-framework-for-microservices/src/kube-openapi/pkg/common"
	...
	return &openapi.Config{
		...
		GetDefinitions: func(_ openapi.ReferenceCallback) map[string]openapi.OpenAPIDefinition {
			return map[string]openapi.OpenAPIDefinition{
				"github.com/vmware-tanzu/graph-framework-for-microservices/src/kube-openapi/pkg/builder.TestInput":             *TestInput{}.OpenAPIDefinition(),
				"github.com/vmware-tanzu/graph-framework-for-microservices/src/kube-openapi/pkg/builder.TestOutput":            *TestOutput{}.OpenAPIDefinition(),
				"github.com/vmware-tanzu/graph-framework-for-microservices/src/kube-openapi/pkg/builder.TestExtensionV2Schema": *TestExtensionV2Schema{}.OpenAPIDefinition(),
			}
		},
