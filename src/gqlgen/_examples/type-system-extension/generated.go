...
func (ec *executionContext) _MyMutation_createTodo(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		return nil, fmt.Errorf(`unexpected type %T from directive, should be *gitlab.eng.vmware.com/nsx-allspark_users/nexus-sdk/gqlgen.git/_examples/type-system-extension.Todo`, tmp)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
