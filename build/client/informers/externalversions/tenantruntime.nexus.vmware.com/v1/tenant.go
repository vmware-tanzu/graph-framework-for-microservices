...
import (
	...
	v1 "golang-appnet.eng.vmware.com/nexus-sdk/api/build/client/listers/tenantruntime.nexus.vmware.com/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.TenantruntimeNexusV1().Tenants().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TenantruntimeNexusV1().Tenants().Watch(context.TODO(), options)
			},
		},
		&tenantruntimenexusvmwarecomv1.Tenant{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *tenantInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&tenantruntimenexusvmwarecomv1.Tenant{}, f.defaultInformer)
}
