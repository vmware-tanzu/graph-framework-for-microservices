...
import (
	...
	v1 "gitlab.eng.vmware.com/nsx-allspark_users/nexus-sdk/api.git/build/client/listers/config.nexus.org/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.ConfigNexusV1().Configs().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ConfigNexusV1().Configs().Watch(context.TODO(), options)
			},
		},
		&confignexusorgv1.Config{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *configInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&confignexusorgv1.Config{}, f.defaultInformer)
}
