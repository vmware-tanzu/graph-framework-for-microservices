...
import (
	...
	v1 "golang-appnet.eng.vmware.com/nexus-sdk/api/build/client/listers/route.nexus.org/v1"
...
func (f *routeInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&routenexusorgv1.Route{}, f.defaultInformer)
}
