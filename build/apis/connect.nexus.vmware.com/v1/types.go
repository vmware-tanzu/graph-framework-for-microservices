...
func (c *Connect) CRDName() string {
	return "connects.connect.nexus.vmware.com"
}
...
func (c *NexusEndpoint) CRDName() string {
	return "nexusendpoints.connect.nexus.vmware.com"
}
...
func (c *ReplicationConfig) CRDName() string {
	return "replicationconfigs.connect.nexus.vmware.com"
}
...
type Hierarchy struct {
	Labels []KVP `json:"labels" yaml:"labels"`
}
...
type ReplicationSource struct {
	...
	Type    ObjectType    `json:"type,omitempty" yaml:"type"`
	Object  SourceObject  `json:"object,omitempty" yaml:"object"`
	Filters SourceFilters `json:"sourceFilters,omitempty" yaml:"filters"`
}

// +k8s:openapi-gen=true
type SourceFilters struct {
	Namespace string `json:"namespace,omitempty" yaml:"namespace"`
	Labels    []KVP  `json:"labels,omitempty" yaml:"labels"`
}
