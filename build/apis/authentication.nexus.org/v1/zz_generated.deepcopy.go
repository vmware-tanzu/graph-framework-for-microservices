...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OIDCNexusStatus) DeepCopyInto(out *OIDCNexusStatus) {
	*out = *in
	out.Nexus = in.Nexus
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OIDCNexusStatus.
func (in *OIDCNexusStatus) DeepCopy() *OIDCNexusStatus {
	if in == nil {
		return nil
	}
	out := new(OIDCNexusStatus)
	in.DeepCopyInto(out)
	return out
}
