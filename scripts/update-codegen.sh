...
popd
./_deps/github.com/kubernetes/code-generator/generate-groups.sh all "${ROOT_PACKAGE}/_generated/client" "${ROOT_PACKAGE}/_generated/apis" "${API_NAMES}" --go-header-file "./_deps/github.com/kubernetes/code-generator/hack/boilerplate.go.txt"
