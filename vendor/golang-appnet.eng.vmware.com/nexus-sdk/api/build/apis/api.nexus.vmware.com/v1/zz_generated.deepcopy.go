...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NexusNexusStatus) DeepCopyInto(out *NexusNexusStatus) {
	*out = *in
	out.Nexus = in.Nexus
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NexusNexusStatus.
func (in *NexusNexusStatus) DeepCopy() *NexusNexusStatus {
	if in == nil {
		return nil
	}
	out := new(NexusNexusStatus)
	in.DeepCopyInto(out)
	return out
}
