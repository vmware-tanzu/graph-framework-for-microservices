...
import (
	...
	v1 "golang-appnet.eng.vmware.com/nexus-sdk/api/build/client/listers/config.nexus.vmware.com/v1"
...
func (f *configInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&confignexusvmwarecomv1.Config{}, f.defaultInformer)
}
