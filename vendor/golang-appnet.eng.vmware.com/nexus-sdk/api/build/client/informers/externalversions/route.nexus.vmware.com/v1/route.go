...
import (
	...
	v1 "golang-appnet.eng.vmware.com/nexus-sdk/api/build/client/listers/route.nexus.vmware.com/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.RouteNexusV1().Routes().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.RouteNexusV1().Routes().Watch(context.TODO(), options)
			},
		},
		&routenexusvmwarecomv1.Route{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *routeInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&routenexusvmwarecomv1.Route{}, f.defaultInformer)
}
