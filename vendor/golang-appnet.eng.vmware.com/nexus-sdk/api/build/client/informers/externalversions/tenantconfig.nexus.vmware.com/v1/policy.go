	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.TenantconfigNexusV1().Policies().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TenantconfigNexusV1().Policies().Watch(context.TODO(), options)
			},
		},
		&tenantconfignexusvmwarecomv1.Policy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *policyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&tenantconfignexusvmwarecomv1.Policy{}, f.defaultInformer)
}
