...
func (r *policypkg_ACPConfigResolver) DestSvcGroups(ctx context.Context, obj *model.PolicypkgACPConfig, id *string) ([]*model.ServicegroupSvcGroup, error) {
	return getPolicypkgACPConfigDestSvcGroupsResolver(obj, id)
}

// SourceSvcGroups is the resolver for the SourceSvcGroups field.
func (r *policypkg_ACPConfigResolver) SourceSvcGroups(ctx context.Context, obj *model.PolicypkgACPConfig, id *string) ([]*model.ServicegroupSvcGroup, error) {
	return getPolicypkgACPConfigSourceSvcGroupsResolver(obj, id)
}
...
// Policypkg_ACPConfig returns generated.Policypkg_ACPConfigResolver implementation.
func (r *Resolver) Policypkg_ACPConfig() generated.Policypkg_ACPConfigResolver {
	return &policypkg_ACPConfigResolver{r}
}
...
type policypkg_ACPConfigResolver struct{ *Resolver }
