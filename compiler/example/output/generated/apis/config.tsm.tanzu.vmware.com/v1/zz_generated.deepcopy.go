...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in AliasedFieldList) DeepCopyInto(out *AliasedFieldList) {
	{
		in := &in
		*out = make(AliasedFieldList, len(*in))
		copy(*out, *in)
		return
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AliasedFieldList.
func (in AliasedFieldList) DeepCopy() AliasedFieldList {
	if in == nil {
		return nil
	}
	out := new(AliasedFieldList)
	in.DeepCopyInto(out)
	return *out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in AliasedFieldMap) DeepCopyInto(out *AliasedFieldMap) {
	{
		in := &in
		*out = make(AliasedFieldMap, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
		return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AliasedFieldMap.
func (in AliasedFieldMap) DeepCopy() AliasedFieldMap {
	if in == nil {
		return nil
	}
	out := new(AliasedFieldMap)
	in.DeepCopyInto(out)
	return *out
}
...
func (in *StructWithEmbeddedField) DeepCopyInto(out *StructWithEmbeddedField) {
	*out = *in
	...
	if in.AliasedFieldMap != nil {
		in, out := &in.AliasedFieldMap, &out.AliasedFieldMap
		*out = make(AliasedFieldMap, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
	if in.AliasedFieldList != nil {
		in, out := &in.AliasedFieldList, &out.AliasedFieldList
		*out = make(AliasedFieldList, len(*in))
		copy(*out, *in)
	}
	return
