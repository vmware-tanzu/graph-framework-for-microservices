	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.GlobalTsmV1().CertificateRequests().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GlobalTsmV1().CertificateRequests().Watch(context.TODO(), options)
			},
		},
		&globaltsmtanzuvmwarecomv1.CertificateRequest{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *certificateRequestInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&globaltsmtanzuvmwarecomv1.CertificateRequest{}, f.defaultInformer)
}
