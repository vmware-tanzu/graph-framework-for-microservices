	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.GlobalTsmV1().SecurityContextConstraintses().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GlobalTsmV1().SecurityContextConstraintses().Watch(context.TODO(), options)
			},
		},
		&globaltsmtanzuvmwarecomv1.SecurityContextConstraints{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *securityContextConstraintsInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&globaltsmtanzuvmwarecomv1.SecurityContextConstraints{}, f.defaultInformer)
}
