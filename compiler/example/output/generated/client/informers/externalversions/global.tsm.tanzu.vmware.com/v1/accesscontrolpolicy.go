	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.GlobalTsmV1().AccessControlPolicies().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GlobalTsmV1().AccessControlPolicies().Watch(context.TODO(), options)
			},
		},
		&globaltsmtanzuvmwarecomv1.AccessControlPolicy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *accessControlPolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&globaltsmtanzuvmwarecomv1.AccessControlPolicy{}, f.defaultInformer)
}
