...
type AutoscalingPolicyInformer interface {
	...
	Lister() v1.AutoscalingPolicyLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.GlobalTsmV1().AutoscalingPolicies().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GlobalTsmV1().AutoscalingPolicies().Watch(context.TODO(), options)
			},
		},
		&globaltsmtanzuvmwarecomv1.AutoscalingPolicy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *autoscalingPolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&globaltsmtanzuvmwarecomv1.AutoscalingPolicy{}, f.defaultInformer)
}

func (f *autoscalingPolicyInformer) Lister() v1.AutoscalingPolicyLister {
	return v1.NewAutoscalingPolicyLister(f.Informer().GetIndexer())
}
