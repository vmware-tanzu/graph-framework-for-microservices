	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.GlobalTsmV1().ClusterConfigs().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GlobalTsmV1().ClusterConfigs().Watch(context.TODO(), options)
			},
		},
		&globaltsmtanzuvmwarecomv1.ClusterConfig{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *clusterConfigInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&globaltsmtanzuvmwarecomv1.ClusterConfig{}, f.defaultInformer)
}
