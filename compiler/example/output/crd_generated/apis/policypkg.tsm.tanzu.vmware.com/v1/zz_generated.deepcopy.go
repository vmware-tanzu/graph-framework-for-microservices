...
func (in *AdditionalPolicyData) DeepCopy() *AdditionalPolicyData {
	if in == nil {
		return nil
	}
	out := new(AdditionalPolicyData)
	in.DeepCopyInto(out)
	return out
}
...
func (in *AdditionalPolicyDataList) DeepCopyInto(out *AdditionalPolicyDataList) {
	*out = *in
	...
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]AdditionalPolicyData, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *AdditionalPolicyDataList) DeepCopy() *AdditionalPolicyDataList {
	if in == nil {
		return nil
	}
	out := new(AdditionalPolicyDataList)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AdditionalPolicyDataNexusStatus) DeepCopyInto(out *AdditionalPolicyDataNexusStatus) {
	*out = *in
	out.Status = in.Status
	out.Nexus = in.Nexus
	return
...
func (in *AdditionalPolicyDataNexusStatus) DeepCopy() *AdditionalPolicyDataNexusStatus {
	if in == nil {
		return nil
	}
	out := new(AdditionalPolicyDataNexusStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *AdditionalPolicyDataSpec) DeepCopy() *AdditionalPolicyDataSpec {
	if in == nil {
		return nil
	}
	out := new(AdditionalPolicyDataSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *RandomPolicyDataList) DeepCopyInto(out *RandomPolicyDataList) {
	*out = *in
	...
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]RandomPolicyData, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *RandomPolicyDataList) DeepCopy() *RandomPolicyDataList {
	if in == nil {
		return nil
	}
	out := new(RandomPolicyDataList)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RandomPolicyDataNexusStatus) DeepCopyInto(out *RandomPolicyDataNexusStatus) {
	*out = *in
	out.Status = in.Status
	out.Nexus = in.Nexus
	return
...
func (in *RandomPolicyDataNexusStatus) DeepCopy() *RandomPolicyDataNexusStatus {
	if in == nil {
		return nil
	}
	out := new(RandomPolicyDataNexusStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *RandomPolicyDataSpec) DeepCopy() *RandomPolicyDataSpec {
	if in == nil {
		return nil
	}
	out := new(RandomPolicyDataSpec)
	in.DeepCopyInto(out)
	return out
}
