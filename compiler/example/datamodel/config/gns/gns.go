...
import (
	...
	policy_pkg "github.com/vmware-tanzu/graph-framework-for-microservices/compiler/example/datamodel/config/policy"
...
type Gns struct {
	...
	GnsAccessControlPolicy policy_pkg.AccessControlPolicy `nexus:"child" nexus-graphql:"type:string"`
