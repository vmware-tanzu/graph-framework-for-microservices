...
sed -i'.bak' -e "s|github.com/go-openapi/spec|github.com/vmware-tanzu/graph-framework-for-microservices/src/kube-openapi/pkg/validation/spec|" ../pkg/openapi_generator/openapi/openapi_generated.go
sed -i'.bak' -e "s|k8s.io/kube-openapi/pkg/common|github.com/vmware-tanzu/graph-framework-for-microservices/src/kube-openapi/pkg/common|" ../pkg/openapi_generator/openapi/openapi_generated.go
popd
